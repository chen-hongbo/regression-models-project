...
At this step, we make the null hypothesis as the MPG of the automatic and manual transmissions are from the same population (assuming the MPG has a normal distribution). We use T-test to show it. 
...
Next, we fit the simple model with MPG as the predictor variable. 
